...
export default {
    props: {
        ...
        selectionsData: { // Novo prop para definir as seleções
            type: Array,
            required: true,
        },
        modelValue: {
    ...
    setup(props, { emit }) {
        ...
        // Atualiza os grupos ativos com base na seleção do usuário
        ...
        // Atualiza os combos ativos com base nos combos selecionados
        ...
        // Observa mudanças nos combos selecionados
